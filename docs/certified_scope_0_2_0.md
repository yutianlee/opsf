...
[`certified_scope_0_1_0.md`](certified_scope_0_1_0.md). The only new public
special-function wrapper planned here is `gamma_ratio(a, b)`.
...
Any change to this scope before 0.2.0-alpha.1 must update this document,
