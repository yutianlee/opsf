...
The release-hygiene audit checks that `pypi-smoke.yml` defaults to `0.3.0`
after the published `v0.3.0` post-release smoke verification and covers
...
after the `0.3.0` smoke-default update.
