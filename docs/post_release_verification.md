...
## v0.3.0-alpha.4 / certsf 0.3.0a4

This records the verification evidence for the fourth 0.3 line prerelease
artifact.

### Published artifact

- Git tag: `v0.3.0-alpha.4`
- GitHub prerelease: <https://github.com/yutianlee/certsf/releases/tag/v0.3.0-alpha.4>
- GitHub release type: prerelease, not draft.
- Source commit: `8f23c6df32a065fc5e9aa8e702dc68fcefe2d094`
- PyPI URL: <https://pypi.org/project/certsf/0.3.0a4/>
- PyPI version: `certsf 0.3.0a4`
- TestPyPI decision: skipped under `release_policy.md` for a routine feature
  alpha; TestPyPI was not used for this prerelease.
- Publish workflow run: `25661919365`
- Publish workflow URL:
  <https://github.com/yutianlee/certsf/actions/runs/25661919365>
- Publish trigger: GitHub `release` event for `v0.3.0-alpha.4`
- PyPI publish result: passed; PyPI JSON shows the wheel and sdist uploaded at
  `2026-05-11T09:29:26.757483Z` and `2026-05-11T09:29:28.127420Z`.
- Wheel SHA256:
  `e67e37b5c038ce048755d9471b5b008ebf461003cee64ecd2733b91dd7befc9f`
- sdist SHA256:
  `a49cf1b3c71047b3669216b2250a8f4d212d10e43d9f57208649d3203775d1e7`
- `pypi-smoke` workflow run: `25663130452`
- `pypi-smoke` workflow URL:
  <https://github.com/yutianlee/certsf/actions/runs/25663130452>
- `pypi-smoke` result: passed against `certsf 0.3.0a4` across base,
  certified, and MCP-certified install paths on Python 3.10, 3.11, and 3.12.
- PyPI edge-cache propagation failures: none observed for `0.3.0a4`.

### Verification status

The Git tag resolves to clean `main` commit
`8f23c6df32a065fc5e9aa8e702dc68fcefe2d094`. The GitHub prerelease is marked
prerelease and is not a draft. The PyPI JSON endpoint returns
`certsf 0.3.0a4` with matching wheel and sdist SHA256 hashes.
...
`pypi-smoke` workflow default and fallback version from `0.3.0a3` to
`0.3.0a4`. It also strengthens Python API and MCP smoke calls for explicit
`gamma(method="stirling_exp")` diagnostics while preserving default direct-Arb
dispatch and the narrow finite positive-real `x >= 20` certificate scope.

## v0.3.0-alpha.3 / certsf 0.3.0a3

This records the verification evidence for the third 0.3 line prerelease
artifact.

### Published artifact

- Git tag: `v0.3.0-alpha.3`
- GitHub prerelease: <https://github.com/yutianlee/certsf/releases/tag/v0.3.0-alpha.3>
- GitHub release type: prerelease, not draft.
- Source commit: `b8dcd98b8f7a31d69c98f0a057d5706c811733b8`
- PyPI URL: <https://pypi.org/project/certsf/0.3.0a3/>
- PyPI version: `certsf 0.3.0a3`
- TestPyPI decision: skipped under `release_policy.md` for a routine feature
  alpha; TestPyPI was not used for this prerelease.
- Publish workflow run: `25632153992`
- Publish workflow URL:
  <https://github.com/yutianlee/certsf/actions/runs/25632153992>
- Publish trigger: GitHub `release` event for `v0.3.0-alpha.3`
- PyPI publish result: passed; PyPI JSON shows the wheel and sdist uploaded at
  `2026-05-10T15:11:10.642109Z` and `2026-05-10T15:11:12.429305Z`.
- Wheel SHA256:
...
- `pypi-smoke` workflow run: `25632204261`
- `pypi-smoke` workflow URL:
  <https://github.com/yutianlee/certsf/actions/runs/25632204261>
- `pypi-smoke` result: passed against `certsf 0.3.0a3` across base,
  certified, and MCP-certified install paths on Python 3.10, 3.11, and 3.12
  after rerunning failed jobs in the same workflow run.
- PyPI edge-cache propagation failures: initial `pypi-smoke` run
  `25632181882` failed during install in selected matrix jobs because the
  runner-visible PyPI index listed versions only through `0.3.0a2`. The first
  attempt of run `25632204261` also had Python 3.12 install failures for the
  certified and MCP-certified jobs with the same runner-visible index lag;
  rerunning failed jobs in `25632204261` passed after propagation completed.

### Verification status

The Git tag resolves to clean `main` commit
`b8dcd98b8f7a31d69c98f0a057d5706c811733b8`. The GitHub prerelease is marked
prerelease and is not a draft. The PyPI JSON endpoint returns
`certsf 0.3.0a3` with matching wheel and sdist SHA256 hashes.
...
After the successful smoke run, this follow-up PR updates the scheduled/manual
`pypi-smoke` workflow default and fallback version from `0.3.0a2` to
`0.3.0a3`. It also strengthens Python API and MCP smoke calls for explicit
`loggamma(method="certified_auto")` preselection diagnostics while preserving
default direct-Arb dispatch and the narrow positive-real custom Stirling
scopes.
...
- GitHub prerelease: <https://github.com/yutianlee/certsf/releases/tag/v0.3.0-alpha.1>
- GitHub release type: prerelease, not draft.
- PyPI URL: <https://pypi.org/project/certsf/0.3.0a1/>
- PyPI version: `certsf 0.3.0a1`
- TestPyPI URL: <https://test.pypi.org/project/certsf/0.3.0a1/>
- TestPyPI workflow run: `25625895759`
- TestPyPI workflow URL:
  <https://github.com/yutianlee/certsf/actions/runs/25625895759>
- TestPyPI result: passed after manual `publish-testpypi` dispatch; the
  confirmation guard, tag/version parity check, build, `twine check`, artifact
  upload, and trusted publishing job all passed.
- Publish workflow run: `25625499969`
- Publish workflow URL:
  <https://github.com/yutianlee/certsf/actions/runs/25625499969>
- Publish trigger: GitHub `release` event for `v0.3.0-alpha.1`
- PyPI publish result: passed; PyPI JSON shows the wheel and sdist uploaded at
  `2026-05-10T09:44:01.341577Z` and `2026-05-10T09:44:02.652941Z`.
- Source commit: `3f92ca5f9de2b83337647bbcfbe2452ea2b1a608`
- Wheel SHA256:
  `4a77e0cbe7321efadfcb0d848dff98e6650fd65ad1a5a81d8a3dc71726774bb6`
- sdist SHA256:
  `1edf26be0c5c57fa8019f18e9635a9deddc35e5078e275fcf244228703e5586d`
- `pypi-smoke` workflow run: `25626012923`
- `pypi-smoke` workflow URL:
  <https://github.com/yutianlee/certsf/actions/runs/25626012923>
- `pypi-smoke` result: passed against `certsf 0.3.0a1` across base,
  certified, and MCP-certified install paths on Python 3.10, 3.11, and 3.12.
- PyPI edge-cache propagation failures: none observed for `0.3.0a1`.

### Verification status

The Git tag points at clean `main` commit
`3f92ca5f9de2b83337647bbcfbe2452ea2b1a608`. The GitHub prerelease is marked
prerelease and is not a draft. The TestPyPI and PyPI JSON endpoints both return
`certsf 0.3.0a1` with matching wheel and sdist SHA256 hashes.
...
After the successful smoke run, this follow-up PR updates the scheduled/manual
`pypi-smoke` workflow default and fallback version from `0.2.0` to `0.3.0a1`.
It also adds Python API and MCP smoke calls for explicit
`loggamma(method="stirling")` and `loggamma(method="stirling_shifted")` while
preserving default direct-Arb dispatch and the narrow positive-real
`stirling_loggamma_positive_real` certificate scope.
