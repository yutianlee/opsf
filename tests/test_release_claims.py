...
FORBIDDEN_CLAIM_PATTERNS = (
    ...
    r"\bactive custom[- ]certified rgamma\b",
    r"\bcustom[- ]certified rgamma is active\b",
    r"\bglobal rgamma certification\b",
    r"\bglobally certified rgamma\b",
    r"\bcomplex reciprocal gamma certification\b",
    ...
    r"\bautomatic default beta selection\b",
